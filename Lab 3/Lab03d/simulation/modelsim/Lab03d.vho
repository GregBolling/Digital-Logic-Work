...
ARCHITECTURE structure OF Lab03d IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \U1|MemOnce~0_combout\ : std_logic;
SIGNAL \U1|MemOnce~q\ : std_logic;
...
SIGNAL \U1|shift_reg~7_combout\ : std_logic;
SIGNAL \U1|shift_reg~8_combout\ : std_logic;
...
-- Equation(s):
-- \U0|Equal0~6_combout\ = (!\U0|count\(3) & (\U0|count\(0) & (!\U0|count\(2) & !\U0|count\(1))))
...
-- Equation(s):
-- \U0|count~4_combout\ = (\U0|Add0~16_combout\ & (((!\U0|Equal0~6_combout\) # (!\U0|Equal0~5_combout\)) # (!\U0|Equal0~4_combout\)))
...
-- Equation(s):
-- \U0|count~3_combout\ = (\U0|Add0~24_combout\ & (((!\U0|Equal0~4_combout\) # (!\U0|Equal0~6_combout\)) # (!\U0|Equal0~5_combout\)))
...
-- Equation(s):
-- \U0|count~2_combout\ = (\U0|Add0~32_combout\ & (((!\U0|Equal0~5_combout\) # (!\U0|Equal0~6_combout\)) # (!\U0|Equal0~4_combout\)))
...
-- Equation(s):
-- \U0|Equal0~1_combout\ = (!\U0|count\(18) & (!\U0|count\(19) & (!\U0|count\(17) & \U0|count\(16))))
...
-- Equation(s):
-- \U0|count~7_combout\ = (\U0|Add0~40_combout\ & (((!\U0|Equal0~4_combout\) # (!\U0|Equal0~5_combout\)) # (!\U0|Equal0~6_combout\)))
...
-- Equation(s):
-- \U0|Equal0~0_combout\ = (!\U0|count\(23) & (\U0|count\(20) & (!\U0|count\(22) & !\U0|count\(21))))
...
-- Equation(s):
-- \U0|Equal0~2_combout\ = (!\U0|count\(15) & (\U0|count\(12) & (!\U0|count\(13) & !\U0|count\(14))))
...
-- Equation(s):
-- \U0|Equal0~3_combout\ = (!\U0|count\(9) & (!\U0|count\(10) & (!\U0|count\(11) & \U0|count\(8))))
...
-- Equation(s):
-- \U0|Equal0~4_combout\ = (\U0|Equal0~1_combout\ & (\U0|Equal0~0_combout\ & (\U0|Equal0~2_combout\ & \U0|Equal0~3_combout\)))
...
-- Equation(s):
-- \U0|count~5_combout\ = (\U0|Add0~8_combout\ & (((!\U0|Equal0~6_combout\) # (!\U0|Equal0~5_combout\)) # (!\U0|Equal0~4_combout\)))
...
-- Equation(s):
-- \U0|Equal0~5_combout\ = (\U0|count\(4) & (!\U0|count\(6) & (!\U0|count\(7) & !\U0|count\(5))))
...
-- Equation(s):
-- \U0|Equal0~7_combout\ = (\U0|Equal0~5_combout\ & (\U0|Equal0~6_combout\ & \U0|Equal0~4_combout\))
...
\U1|MemOnce~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U1|MemOnce~0_combout\ = (\U1|shift_reg\(7)) # (\U1|MemOnce~q\)
...
-- pragma translate_on
PORT MAP (
	dataa => \U1|shift_reg\(7),
	datac => \U1|MemOnce~q\,
	combout => \U1|MemOnce~0_combout\);
...
-- Equation(s):
-- \U1|shift_reg~1_combout\ = (\U1|MemOnce~q\ & (!\U1|shift_reg\(0) & ((\U1|shift_reg\(2))))) # (!\U1|MemOnce~q\ & (\U1|shift_reg\(0) & (!\U1|shift_reg\(7))))
...
-- Equation(s):
-- \U1|shift_reg~2_combout\ = (\U1|MemOnce~q\ & (!\U1|shift_reg\(0))) # (!\U1|MemOnce~q\ & ((!\U1|shift_reg\(7))))
...
-- Equation(s):
-- \U1|shift_reg~3_combout\ = (\U1|shift_reg~2_combout\ & ((\U1|MemOnce~q\ & (\U1|shift_reg\(3))) # (!\U1|MemOnce~q\ & ((\U1|shift_reg\(1))))))
...
PORT MAP (
	...
	datac => \U1|shift_reg\(1),
	datad => \U1|shift_reg~2_combout\,
...
-- Equation(s):
-- \U1|shift_reg~4_combout\ = (\U1|shift_reg~2_combout\ & ((\U1|MemOnce~q\ & ((\U1|shift_reg\(4)))) # (!\U1|MemOnce~q\ & (\U1|shift_reg\(2)))))
...
-- Equation(s):
-- \U1|shift_reg~5_combout\ = (\U1|shift_reg~2_combout\ & ((\U1|MemOnce~q\ & (\U1|shift_reg\(5))) # (!\U1|MemOnce~q\ & ((\U1|shift_reg\(3))))))
...
-- Equation(s):
-- \U1|shift_reg~6_combout\ = (\U1|shift_reg~2_combout\ & ((\U1|MemOnce~q\ & (\U1|shift_reg\(6))) # (!\U1|MemOnce~q\ & ((\U1|shift_reg\(4))))))
...
\U1|shift_reg~7\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U1|shift_reg~7_combout\ = (\U1|MemOnce~q\ & (!\U1|shift_reg\(0) & (\U1|shift_reg\(7)))) # (!\U1|MemOnce~q\ & (((!\U1|shift_reg\(7) & \U1|shift_reg\(5)))))
...
PORT MAP (
	...
	datab => \U1|shift_reg\(0),
	datac => \U1|shift_reg\(7),
	datad => \U1|shift_reg\(5),
	combout => \U1|shift_reg~7_combout\);
...
\U1|shift_reg~8\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U1|shift_reg~8_combout\ = (\U1|MemOnce~q\ & (((!\U1|shift_reg\(0))))) # (!\U1|MemOnce~q\ & (\U1|shift_reg\(6) & (!\U1|shift_reg\(7))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U1|shift_reg\(6),
	datab => \U1|MemOnce~q\,
	datac => \U1|shift_reg\(7),
	datad => \U1|shift_reg\(0),
	combout => \U1|shift_reg~8_combout\);
...
-- Equation(s):
-- \U1|shift_reg~0_combout\ = (\U1|MemOnce~q\ & (((\U1|shift_reg\(1) & !\U1|shift_reg\(0))))) # (!\U1|MemOnce~q\ & (!\U1|shift_reg\(7)))
