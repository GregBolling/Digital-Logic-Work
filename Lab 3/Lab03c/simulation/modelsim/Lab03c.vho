...
ARCHITECTURE structure OF Lab03c IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \U1|shift_reg[0]~7_combout\ : std_logic;
...
-- Equation(s):
-- \U1|shift_reg~0_combout\ = (\U1|shift_reg\(0)) # (!\U1|shift_reg\(7))
...
-- Equation(s):
-- \U1|shift_reg~1_combout\ = (\U1|shift_reg\(1)) # (!\U1|shift_reg\(7))
...
-- Equation(s):
-- \U1|shift_reg~2_combout\ = (\U1|shift_reg\(2)) # (!\U1|shift_reg\(7))
...
-- Equation(s):
-- \U1|shift_reg~3_combout\ = (\U1|shift_reg\(3)) # (!\U1|shift_reg\(7))
...
-- Equation(s):
-- \U1|shift_reg~4_combout\ = (\U1|shift_reg\(4)) # (!\U1|shift_reg\(7))
...
-- Equation(s):
-- \U1|shift_reg~5_combout\ = (\U1|shift_reg\(5)) # (!\U1|shift_reg\(7))
...
-- Equation(s):
-- \U1|shift_reg~6_combout\ = (\U1|shift_reg\(6)) # (!\U1|shift_reg\(7))
...
\U1|shift_reg[0]~7\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \U1|shift_reg[0]~7_combout\ = !\U1|shift_reg\(7)
...
PORT MAP (
	datad => \U1|shift_reg\(7),
	combout => \U1|shift_reg[0]~7_combout\);
