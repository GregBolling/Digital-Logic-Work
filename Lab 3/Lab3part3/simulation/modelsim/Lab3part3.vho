...
SIGNAL \present_state.S2~feeder_combout\ : std_logic;
SIGNAL \present_state.S2~q\ : std_logic;
SIGNAL \present_state.S3~feeder_combout\ : std_logic;
SIGNAL \present_state.S3~q\ : std_logic;
SIGNAL \present_state.S0~0_combout\ : std_logic;
SIGNAL \present_state.S0~q\ : std_logic;
SIGNAL \a_g~0_combout\ : std_logic;
SIGNAL \ALT_INV_reset~input_o\ : std_logic;
SIGNAL \ALT_INV_a_g~0_combout\ : std_logic;
SIGNAL \ALT_INV_present_state.S0~q\ : std_logic;
...
\ALT_INV_a_g~0_combout\ <= NOT \a_g~0_combout\;
\ALT_INV_present_state.S0~q\ <= NOT \present_state.S0~q\;
...
-- Equation(s):
-- \present_state.S1~0_combout\ = !\present_state.S0~q\
...
\present_state.S2~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \present_state.S2~feeder_combout\ = \present_state.S1~q\
...
PORT MAP (
	...
	combout => \present_state.S2~feeder_combout\);
...
PORT MAP (
	clk => \clock~inputclkctrl_outclk\,
	d => \present_state.S2~feeder_combout\,
	clrn => \ALT_INV_reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\present_state.S3~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \present_state.S3~feeder_combout\ = \present_state.S2~q\
...
PORT MAP (
	...
	combout => \present_state.S3~feeder_combout\);
...
PORT MAP (
	clk => \clock~inputclkctrl_outclk\,
	d => \present_state.S3~feeder_combout\,
	clrn => \ALT_INV_reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \present_state.S0~0_combout\ = !\present_state.S3~q\
...
\a_g~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \a_g~0_combout\ = (\present_state.S2~q\) # (!\present_state.S0~q\)
