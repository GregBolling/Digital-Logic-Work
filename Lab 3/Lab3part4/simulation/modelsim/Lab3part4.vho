...
ARCHITECTURE structure OF lab3part4 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \U0|count~4_combout\ = (\U0|Add0~16_combout\ & (((!\U0|Equal0~6_combout\) # (!\U0|Equal0~4_combout\)) # (!\U0|Equal0~5_combout\)))
...
-- Equation(s):
-- \U0|count~3_combout\ = (\U0|Add0~24_combout\ & (((!\U0|Equal0~4_combout\) # (!\U0|Equal0~5_combout\)) # (!\U0|Equal0~6_combout\)))
...
-- Equation(s):
-- \U0|Equal0~1_combout\ = (!\U0|count\(18) & (\U0|count\(16) & (!\U0|count\(19) & !\U0|count\(17))))
...
-- Equation(s):
-- \U0|Equal0~0_combout\ = (!\U0|count\(21) & (!\U0|count\(22) & (\U0|count\(20) & !\U0|count\(23))))
...
-- Equation(s):
-- \U0|Equal0~3_combout\ = (!\U0|count\(9) & (\U0|count\(8) & (!\U0|count\(10) & !\U0|count\(11))))
...
-- Equation(s):
-- \U0|Equal0~6_combout\ = (!\U0|count\(2) & (!\U0|count\(1) & (!\U0|count\(3) & \U0|count\(0))))
...
-- Equation(s):
-- \U0|Equal0~5_combout\ = (!\U0|count\(7) & (!\U0|count\(6) & (\U0|count\(4) & !\U0|count\(5))))
...
PORT MAP (
	clk => \clock~inputclkctrl_outclk\,
	asdata => \U0|slow_clock~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \U0|slow_clock~q\);
...
\count[0]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \count[0]~3_combout\ = !count(3)
...
-- Equation(s):
-- \count~1_combout\ = (count(0) & (!count(3) & ((!count(1)) # (!count(2)))))
...
-- Equation(s):
-- \count~2_combout\ = (count(1) & count(2))
...
-- Equation(s):
-- \count~0_combout\ = (!count(1) & !count(3))
...
-- Equation(s):
-- \U1|Mux6~0_combout\ = (count(1) & (((count(3))))) # (!count(1) & (count(2) $ (((!count(3) & count(0))))))
...
-- Equation(s):
-- \U1|Mux5~0_combout\ = (count(2) & ((count(3)) # (count(1) $ (count(0))))) # (!count(2) & (count(1) & (count(3))))
...
-- Equation(s):
-- \U1|Mux4~0_combout\ = (count(2) & (((count(3))))) # (!count(2) & (count(1) & ((count(3)) # (!count(0)))))
...
-- Equation(s):
-- \U1|Mux2~0_combout\ = (count(0)) # ((count(1) & ((count(3)))) # (!count(1) & (count(2))))
...
-- Equation(s):
-- \U1|Mux1~0_combout\ = (count(2) & ((count(3)) # ((count(1) & count(0))))) # (!count(2) & ((count(1)) # ((!count(3) & count(0)))))
...
-- Equation(s):
-- \U1|Mux0~0_combout\ = (count(1) & (!count(3) & ((!count(0)) # (!count(2))))) # (!count(1) & (count(2) $ ((count(3)))))
